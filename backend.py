...
if __name__ == "__main__":
    apk_path = input("Enter the path to the APK file (do not include quotes): ")

    # Start scanning for vulnerabilities
    print("Scanning APK for vulnerabilities...")
    vulnerabilities = scan_apk(apk_path.strip())  # Use strip() to remove any leading/trailing spaces
    ...
    # Save the report
    report_path = r"C:\Users\pooja\Downloads\App Shield\security_report.txt"  # Specify a full path
    save_report(vulnerabilities, open_ports, report_path)
